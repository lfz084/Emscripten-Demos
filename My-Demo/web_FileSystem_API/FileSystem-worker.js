...
if (ENVIRONMENT_IS_WEB) {
  ...
  Object.assign(msg_exports, {
  	newFile: createMessageFunction("newFile"),
  	deleteFile: createMessageFunction("deleteFile"),
  	openFilePicker: createMessageFunction("openFilePicker"),
  	saveFilePicker: createMessageFunction("saveFilePicker"),
  	openFile: createMessageFunction("openFile"),
  	closeFile: createMessageFunction("closeFile"),
  	flushFile: createMessageFunction("flushFile"),
  	truncateFile: createMessageFunction("truncateFile"),
  	seekFile: createMessageFunction("seekFile"),
  	getFileSize: createMessageFunction("getFileSize"),
  	readFile: createMessageFunction("readFile"),
  	writeFile: createMessageFunction("writeFile"),
  })
} else
  if (ENVIRONMENT_IS_WORKER) {
