...
var ASM_CONSTS = {
  68187: ($0) => { console.log("EM_ASM: " + UTF8ToString($0)); }
};
function em_js(str) { console.log("EM_JS: " + UTF8ToString(str)); }
function __asyncjs__em_async_js(str) { return Asyncify.handleAsync(async () => { await new Promise(resolve => setTimeout(resolve, 1800)); console.log("EM_ASYNC_JS: " + UTF8ToString(str)); }); }
