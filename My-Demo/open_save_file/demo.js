...
var _readFile = Module['_readFile'] = makeInvalidEarlyAccess('_readFile');
var _writeFile = Module['_writeFile'] = makeInvalidEarlyAccess('_writeFile');
...
function assignWasmExports(wasmExports) {
  Module['_readFile'] = _readFile = createExportWrapper('readFile', 0);
  Module['_writeFile'] = _writeFile = createExportWrapper('writeFile', 0);
...
var wasmImports = {
  ...
  fd_write: _fd_write,
  /** @export */
  js_getSize: _js_getSize,
  /** @export */
  js_read: _js_read,
  /** @export */
  js_seek: _js_seek,
  /** @export */
  js_truncate: _js_truncate,
  /** @export */
  js_write: _js_write
};
var wasmExports;
